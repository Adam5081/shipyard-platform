  ...
  map() {
    ...
    return `
      ...
      <div class="map-stage" style="padding:0;overflow:hidden;border-radius:var(--radius-m)">
        <iframe id="ascentFrame" src="index-game.html?${GUEST() ? "demo=1" : "intro=0"}&v=55&lang=${(window.TaulauI18n ? window.TaulauI18n.lang() : "ru")}" style="width:100%;height:430px;border:0;display:block" title="TAULAU ASCENT"></iframe>
      </div>
